...
const Footer = () => {
  return (
    <div>
        <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-12 mt-40 text-sm my-10'>
            <div>
                <img src={assets.logo} className='w-36 mb-5' alt="" />
        ...
        <div>
            ...
            <p className='text-center py-4 text-sm'>Copyright 2024@ greatstack.dev - All Right Reserved.</p>
        </div>
    </div>
  )
}
